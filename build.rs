...
fn main() {
    ...
    if env::var("CARGO_CFG_TARGET_OS").as_deref() == Ok("macos") {
        ...
        assert!(output.status.success(), "Could not locate the Apple Clang runtime");
        ...
        assert!(directory.join("libclang_rt.osx.a").is_file(), "Apple Clang's macOS runtime is missing");
