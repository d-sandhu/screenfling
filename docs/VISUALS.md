...
The current preview was generated by [CI run 36161472927](https://github.com/d-sandhu/screenfling/actions/runs/36161472927) from its actual `review.png`. Its artifact also records exact crop-pixel comparison, native settings typing and the separate two-terminal paste fixture.
